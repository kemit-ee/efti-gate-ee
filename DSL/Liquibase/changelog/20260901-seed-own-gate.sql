...
--changeset efti:EU-EE context:dev splitStatements:false
...
INSERT INTO gates (id, country_code, status, e_delivery_url, e_delivery_cert, status)
SELECT 'EU-EE', 'EE', 'ONLINE', 'http://edelivery:8081/services/msh',
...
--changeset efti:EU-MOCK context:dev splitStatements:false
