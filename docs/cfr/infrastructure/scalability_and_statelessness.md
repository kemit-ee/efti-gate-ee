...
> Part of [Theme: Infrastructure](README.md). Architecture: [infrastructure/README.md](../../architecture/infrastructure/README.md) (theme-wide rules) + [infrastructure/scalability_and_statelessness.md](../../architecture/infrastructure/scalability_and_statelessness.md) (sub-architecture).
