...
The full contract — endpoint shape, batching strategy, idempotency rules, retention windows — lives in **Epic 26** ([`../../cfr/infrastructure/append_only_archival.md`](../../cfr/infrastructure/append_only_archival.md)).
...
- Archival epic: [`../../cfr/infrastructure/append_only_archival.md`](../../cfr/infrastructure/append_only_archival.md)
