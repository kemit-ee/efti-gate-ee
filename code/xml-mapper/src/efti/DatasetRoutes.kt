...
class DatasetRoutes {
  ...
  @POST("/request-to-xml") fun requestToXml(req: DatasetQueryRequest, @HeaderParam("x-request-id") queryId: UUID = UUID.randomUUID()): String =
    FTI009GetCmdsRequest(ExchangedDocument("009", queryId), req.subsets, req.uil).render()
  ...
  @POST("/response-to-xml") fun responseToXml(xml: String, @HeaderParam("x-request-id") queryId: UUID = UUID.randomUUID()): String {
