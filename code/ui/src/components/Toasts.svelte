...
<div class="fixed z-50 inset-0 flex items-start pointer-events-none p-6 mt-10" aria-live="assertive">
  <div class="toasts w-full flex flex-col items-end space-y-4">
